...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabranueva=palabras.join(' ');
   return palabranueva;
}
...
var numeroArrayString = numeroString.split("");

if (numeroArrayString[0]== 9){
   return true;
} return false;
...
var suma = num;
   ...
   for (var i = 0; i <10; i++) {
      ...
      if (suma===i) break;
      else   arregloValores.push(suma);
   } 
   if (i<10) return "Se interrumpió la ejecución";
   else return arregloValores;
}
